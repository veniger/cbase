...
## Project Overview
cbase is a cross-platform (Windows, Linux, macOS) single-file C99 utility library meant to be included in other C projects. It provides threading, math, IO, and other common utilities.
...
- Struct types may contain platform-specific handle fields guarded by `#ifdef`; on Windows, internal bookkeeping fields are prefixed `cb__` and marked "do not touch"
